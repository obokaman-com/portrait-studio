...
export const WandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.388 1.62a15.998 15.998 0 00-1.62-3.385m-1.622 3.385a15.998 15.998 0 01-3.388 1.621m-5.043-.025a15.998 15.998 0 01-1.622-3.385m-1.622 3.385a15.998 15.998 0 003.388 1.622m-3.388-1.622a15.998 15.998 0 013.388-1.622m5.043 0a15.998 15.998 0 00-3.388-1.621m-1.622-3.385a15.998 15.998 0 01-1.622 3.385m3.388-1.622a15.998 15.998 0 001.622 3.385m0 0a15.998 15.998 0 01-3.388 1.622m2.245-5.043a1.5 1.5 0 01.3-1.023 1.5 1.5 0 01.865-.623 1.5 1.5 0 011.634 1.634 1.5 1.5 0 01-.623.865 1.5 1.5 0 01-1.023.3z" />
    </svg>
);
